  ...
  return (
    <div className="p-5 flex justify-center mt-8">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 max-w-3xl transition-transform duration-300 ease-in-out transform hover:scale-105 hover:border-2 hover:border-primary hover:shadow-xl">
        ...
        AceMock uses the Google Gemini API to provide a seamless mock interview, mock assessment and resume match experience. 
          Here's how it works:
        </p>
        <ol className="list-decimal list-inside space-y-2 text-left text-gray-700 dark:text-gray-300">
          ...
          <li>
            <strong>Select Your Preferences:</strong> Choose the mock interview, mock assessment, and resume match relevant need to build your career.
          </li>
          <li>
            <strong>Receive Questions:</strong> The Google Gemini API generates tailored interview and assessment questions based on your selections.
          </li>
          <li>
