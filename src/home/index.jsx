...
import { FaBook, FaComments, FaUsers, FaTools, FaPen, FaBookOpen } from 'react-icons/fa';
    ...
    <div className="font-sans min-h-screen flex flex-col items-center justify-center text-center px-4 animate-bg-gradient">
      ...
      >
        <h2 className="text-3xl md:text-5xl font-bold text-gray-800 mb-4">
          Everything you need to ace your interviews and assessment
        </h2>
        <p className="text-lg md:text-xl text-gray-600 mt-2">
          Level up your career and land your next role with mock interviews, live feedback and assessment.
        </p>
      </motion.div>
      ...
      >
        {[
          { name: 'Mock Interviews', icon: <FaUsers /> },
          { name: 'Assessment', icon: <FaBookOpen /> },
          { name: 'Resume Analysis', icon: <FaBook /> },
          { name: 'Feedbak System', icon: <FaComments /> },
        ].map((item, index) => (
          <motion.div
            key={index}
            variants={{
