  ...
  return (
    <div className="p-3 px-5 flex flex-col sm:flex-row justify-between items-center shadow-sm bg-white text-gray-800">
      ...
      <div className="flex flex-col sm:flex-row flex-grow justify-center items-center gap-4 sm:gap-8">
        ...
        <Link to="/mockinterviewfeedback" className="text-gray-800 hover:text-primary font-semibold transition-transform duration-200 transform hover:scale-105">
          Mock Interview Feedbacks
        </Link>
        {/* <Link to="/InterviewFeedbackList" className="text-gray-800 hover:text-primary font-semibold transition-transform duration-200 transform hover:scale-105">
          Ask Questions?
        </Link> */}
