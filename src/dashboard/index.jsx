...
import InterviewFeedbacklist from './InterviewFeedbackList.jsx';
import AddNewAssessment from '../components/custom/AddNewAssessment.jsx'
...
function Dashboard() {
  ...
  return (
    <div className='p-10 items-center'>
      ...
      <h2 className='text-gray-500 font-semibold flex justify-center'></h2>
      ...
      <div className="max-w-5xl mx-auto my-8 p-8 bg-white shadow-lg rounded-lg border-2 border-transparent hover:border-primary transition-all duration-300 flex flex-col">
        ...
        <div className="flex flex-row">
          ...
          <div className="w-1/2 p-6 flex flex-col justify-center items-center">
            <h3 className="text-xl font-bold text-primary mb-4">How to Use the AceMock Website</h3>
            ...
            <p className="text-gray-700 mb-2 text-center">
              2. <span className="font-bold">Add a New Assessment</span> - Begin by selecting the assessment area and level you want to be assessed on. This feature allows you to tailor your assessment experience to your specific career goals.
            </p>
            <p className="text-gray-700 mb-2 text-center">
              3. <span className="font-bold">Check Your ATS Score</span> - Upload your resume and use the ATS Score Checker to evaluate your resume's compatibility with job requirements. This tool ensures your resume is optimized before interviews.
            </p>
            <p className="text-gray-700 mb-2 text-center">
              4. <span className="font-bold">Experience Realistic Mock Interviews</span> - Go through various interview stages that simulate real interview scenarios, complete with questions specific to your selected job role and skill level.
            </p>
            <p className="text-gray-700 mb-2 text-center">
              5. <span className="font-bold">Receive Constructive Feedback</span> - After completing each stage, receive detailed feedback to identify your strengths and areas for improvement, helping you perform better in actual interviews.
            </p>
          </div>
        ...
        <div className="flex justify-center mt-4">
          {/* <Link to="/ask">
            <button className="py-2 px-6 bg-primary text-white font-semibold rounded-lg hover:bg-blue-900 transition duration-300 border-2 border-transparent hover:border-primary">
